...
```{r}
hallux_weight <- dbscan::dbscan(hawks_k_means_dbscan_hallux_weight, eps = 50, MinPts =  5)
fviz_cluster(hallux_weight, hawks_k_means_dbscan_hallux_weight, geom = "point")
hallux_weight <- dbscan::dbscan(hawks_k_means_dbscan_hallux_weight, eps = 30, MinPts =  6)
fviz_cluster(hallux_weight, hawks_k_means_dbscan_hallux_weight, geom = "point")
